...
Bis jetzt war dieser Prozess allerdings extrem umständlich: Der Antrag glich eher einer unübersichtlichen Fragensammlung auf Moodle, begleitet von viel Papierkram, intransparenten Kommunikationswegen und dem ständigen Jagen nach Unterschriften. 
...
Um das komplexe Zusammenspiel der verschiedenen Akteure abzubilden, haben wir uns für eine moderne, leichtgewichtige Architektur entschieden. Das Frontend wurde als Single-Page-Application mit **Vue.js** entwickelt, während im Backend **PocketBase** zum Einsatz kommt. 
...
Während der Entwicklung haben wir die echten administrativen Prozesse nicht nur blind digitalisiert, sondern kontinuierlich hinterfragt und optimiert. So haben wir beispielsweise den Workflow für das finale Kolloquiumsprotokoll so verschlankt, dass Prüfende dieses direkt im System freigeben können, was den Prüfungsausschuss entlastet und den Prozess massiv beschleunigt.

### Das Ergebnis
Entstanden ist der Thesis Manager: Eine responsive **Single-Page-Webanwendung (SPA)**, die das bisherige Zettelchaos durch klare, digitale Workflows ersetzt. 

Unsere Kernfunktionen auf einen Blick:
* **Single Sign-On (SSO) & Smartes Routing:** Nutzer loggen sich bequem über ihren HTW-Google-Account ein. Eine intelligente Logik im Hintergrund erkennt die Rolle (Studierende, Prüfende, PA, Verwaltung) und leitet direkt auf das passgenaue Dashboard weiter.
